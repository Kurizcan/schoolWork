...
public class EditorProductNoContent extends Product {
    ...
    {
        return new Editor(fontStyle.getSelectedItem().toString(), Integer.parseInt(fontSize.getSelectedItem().toString()));
    }
